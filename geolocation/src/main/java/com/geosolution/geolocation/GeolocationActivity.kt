...
import com.geosolution.geolocation.GeoLocationLocationRequest.Companion.checkAvailableService
...
class GeoLocationActivity : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    companion object {
        ...
        private const val PREF_NAME = "geolocation_pref"
    }
...
//                }
    ...
    private fun showPermissionRationale() {
        val title = getString(R.string.geolocation_rationale_title)
        val message = getString(R.string.geolocation_rationale_message)
    ...
    private fun showPermanentlyDeniedDialog() {
        ...
        val title = getString(R.string.geolocation_permission_blocked_title)
        val message = getString(R.string.geolocation_permission_blocked_message)
        AlertDialog.Builder(this)
            .setTitle(title)
            .setMessage(message)
    ...
    private fun checkSettingsWithGMS(
        ...
        builder.addLocationRequest((config.locationRequest as GeoLocationLocationRequest.GeoLocationGMSLocationRequest).locationRequest)
    ...
    private fun checkSettingsWithHMS(
        ...
        builder.addLocationRequest((config.locationRequest as GeoLocationLocationRequest.GeoLocationHMSLocationRequest).locationRequest)
        builder.setAlwaysShow(true)
    ...
    private fun onResolutionNeeded(exception: Exception) {
        ...
        val title = getString(R.string.geolocation_location_resolution_title)
        val message = getString(R.string.geolocation_location_resolution_message)
        AlertDialog.Builder(this)
            .setTitle(title)
            .setMessage(message)
